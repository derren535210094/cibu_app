        ...
        if (!currentFocus.hasPrimaryFocus) {
          currentFocus.unfocus();
            ...
            validator: (value){
             ...
             Column(
              children: [
                GradientText('Masukkan jumlah orang :',
                  style: const TextStyle(
                    fontSize: 25,
                    height: 2
                  ),
                  ...
                  onPressed: (){
                     if (validatorKey.currentState != null) {
                      if(validatorKey.currentState!.validate())
                      {
                         ...
                         setState(() {
                      cek = true;
                      double inputValues = double.parse(_controllers.text);
                      double inputValue = double.parse(_controller.text);
                      double doubledValue = inputValue / inputValues;
                      String formattedNumber = doubledValue.toStringAsFixed(2);
                      valueuang = formattedNumber.toString();

                    });

                      }
                      else if((value == null || value.isEmpty) || ((_controllers.text==null) || (_controller.text==null))){
                       setState(() {
                        cek = false;
                       });
                      } else {
