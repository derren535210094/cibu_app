...
class _UserInfromationScreenState extends State<UserInfromationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    child: Scaffold(
      ...
      child: SingleChildScrollView(
          ...
          child: Column(
            ...
            icon: const Icon(Icons.people, color: Colors.white, size: 35),
            ...
            validator: (value){
                     ...
                     if(value == null || value.isEmpty)
                      ...
                      } else if((value.contains(RegExp(r'[1-9]'))==true)){
                        return "Nama tidak boleh menggunakan angka";
                      } else if((value.contains(RegExp(r'[^\w\s]'))==true)){
           ...
           validator: (value){
                     ...
                     if(value == null || value.isEmpty)
                      ...
                      } else if((value.contains(RegExp(r'^[\w-\.]+@([\w-]+\.)+[\w-]{2,4}$'))==false)){
            ...
            validator: (value){
                     ...
                     if(value == null || value.isEmpty)
                      ...
                      else if((value.length<8) || (value.contains(RegExp(r'[A-Z]'))==false) || (value.contains(RegExp(r'[1-9].*[1-9].*[1-9]'))==false)){
    ...
    onSuccess: () {
              ...
              Column(              
              children: [
                GradientText('Konfirmasi Password :',
                  style: const TextStyle(
                    fontSize: 25,
                    height: 2
                  ),
             ...
             const SizedBox(height: 25),
                  ...
                  onPressed: () => {
                    if (validatorKey.currentState != null) {
                      ...
                      else if((value == null || value.isEmpty) || (passwordController.text!=confirmpassword.text)){
                        print("UnSuccessfull"),
